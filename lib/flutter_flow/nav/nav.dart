...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
            name: BreakfastWidget.routeName,
            path: BreakfastWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: BreakfastWidget(),
                )),
        FFRoute(
            name: PancakesWidget.routeName,
            path: PancakesWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: PancakesWidget(),
                )),
        FFRoute(
            name: LunchWidget.routeName,
            path: LunchWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: LunchWidget(),
                )),
        FFRoute(
            name: DinnerWidget.routeName,
            path: DinnerWidget.routePath,
            builder: (context, params) => NavBarPage(
                  initialPage: '',
                  page: DinnerWidget(),
                )),
